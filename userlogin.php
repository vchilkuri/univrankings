...
if(!empty($_POST["login"])) {
	$result = mysqli_query($conn,"SELECT * FROM registered_users WHERE user_name='" . $_POST["user_name"] . "' and password = '". $_POST["password"]."'");
...
<p> Not a member yet? <a href="regform.php">Join Us</a></p>
<p> Return to <a href="home.html">Home</a></p>
<p> Forgot Password? <a href="forgotpassword.php">Click Here</a></p>
<?php
} else {
$result = mysqlI_query($conn,"SELECT * FROM registered_users WHERE user_id='" . $_SESSION["user_id"] . "'");
$row  = mysqli_fetch_array($result);
?>
