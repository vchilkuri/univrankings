...
<body>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <br>
    <br>
    <form class="form-horizontal" action="admin_new_entry.php" method="post" enctype="multipart/form-data">
  <fieldset>
  ...
  <form class="form-horizontal" action="admin_update_entry.php" method="post" enctype="multipart/form-data">
<fieldset>


<!-- Form Name -->
<legend>Update University Details Here</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="univ_name">University Name</label>
  <div class="col-md-4">
    <select id="univ_name_rank" name="univ_name_rank" class="form-control">
    ...
    <!-- Text input-->
    <div class="form-group">
    <label class="col-md-4 control-label" for="confname">Confirm University Name</label>
    <div class="col-md-4">
    <input id="confname" name="confname" type="text" placeholder="New Name" class="form-control input-md">
    ...
    <!-- Text input-->
    <div class="form-group">
    <label class="col-md-4 control-label" for="newranking">New Ranking</label>
    <div class="col-md-4">
    <input id="newranking" name="newranking" type="text" placeholder="New Ranking" class="form-control input-md">
